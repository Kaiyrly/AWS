...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/amplify_api_ios/amplify_api_ios.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/amplify_datastore/amplify_datastore.framework"
